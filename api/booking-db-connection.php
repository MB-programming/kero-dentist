...
define('BOOKING_DB_NAME', 'kero_dentist_bookings');
define('BOOKING_DB_USER', 'root'); // Change this in production
define('BOOKING_DB_PASS', ''); // Change this in production
...
try {
    ...
    $dsn = "mysql:host=" . BOOKING_DB_HOST . ";charset=" . BOOKING_DB_CHARSET;
    ...
    $booking_conn->exec("CREATE DATABASE IF NOT EXISTS " . BOOKING_DB_NAME . " CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");

    // Select the database
    $booking_conn->exec("USE " . BOOKING_DB_NAME);
