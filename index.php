...
<body>
                ...
                <div class="modern-service-card">
                    ...
                    <div class="modern-service-content">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px;">
                            ...
                            <a href="#booking?package=<?php echo $package['id']; ?>" class="modern-btn modern-btn-primary booking-package-btn" data-package-id="<?php echo $package['id']; ?>" style="padding: 10px 20px; font-size: 14px;">
                                احجز الآن
                            </a>
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Check URL for package parameter
        ...
        if (packageId) {
            ...
            if (packageSelect) {
                ...
                // Trigger change event to show package preview
        ...
        document.querySelectorAll('.booking-package-btn').forEach(btn => {
